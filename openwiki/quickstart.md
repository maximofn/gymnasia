...
flowchart TD
    ...
    App --> External["Open Food Facts and GitHub Releases"]
...
- **Servicios e integraciones:** [Proxy CORS de Anthropic para navegadores](services/anthropic-proxy.md), [Tablero de arquitectura](services/architecture-board.md) e [Integración retirada de VivaGym y actualizaciones de la aplicación](integrations/vivagym-and-updates.md).
...
| Reintroducir VivaGym o cambiar la detección de actualizaciones del APK | [Integración retirada de VivaGym y actualizaciones](integrations/vivagym-and-updates.md) | `legacySecureStorage.ts`, `checkForUpdate`, `runManualUpdateCheck`, `compareVersions` | Contrato de retirada, comprobación de tipos, conjunto determinista e inspección del artefacto nativo |
