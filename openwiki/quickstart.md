...
flowchart TD
    ...
    App --> External["Open Food Facts VivaGym and GitHub policy"]
...
| Cambiar el QR de VivaGym o la distribución manual de APK | [VivaGym y APK manuales](integrations/vivagym-and-updates.md) | `fetchVivaGymAppToken`, `loginVivaGym`, `fetchVivaGymQrValue`, `getVivaGymQr`, `.github/workflows/build-apk.yml` | Comprobación de tipos y pruebas del QR que protejan los secretos; para publicación, validar el artefacto sin añadir un actualizador al cliente |
...
- **El restablecimiento es parcial.** `resetLocalData` no borra todas las preferencias, la memoria personal, los alimentos personales, las credenciales de VivaGym, las cachés, las trazas ni los metadatos. No lo describas como un borrado completo del dispositivo.
