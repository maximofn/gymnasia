...
La creación de ejercicios personalizados no escribe incidencias desde el cliente. La actualización local y su guardado normal no esperan publicación externa, no dependen de ella ni reciben información de procedencia. Si se propone conectar esta acción a feedback, debe atravesar el [Worker de feedback](../services/feedback-worker.md) con un contrato explícito y saneado; no introduzcas credenciales de GitHub en la aplicación.
