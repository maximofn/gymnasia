  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: mobileTheme.color.bgApp }}>
      ...
      {loading ? (
        ...
        <ScrollView ref={mainScrollRef} style={{ flex: 1 }} contentContainerStyle={{ paddingHorizontal: mobileTheme.spacing[4], paddingBottom: 90 }} keyboardShouldPersistTaps="handled" showsVerticalScrollIndicator={tab !== "settings" && tab !== "home" && tab !== "training"}>
