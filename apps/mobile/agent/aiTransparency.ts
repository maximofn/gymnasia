...
export const AI_TRANSPARENCY_COPY = {
  es: {
    agentName: "Agente",
    disclosureTitle: "Agente · inteligencia artificial",
    disclosureBody:
    ...
    disclosureAccessibilityLabel:
      "Agente, inteligencia artificial. No es una persona. Puede cometer errores. Contrasta la información importante, especialmente la relacionada con tu salud.",
    introMessage:
      "Soy Agente, el sistema de inteligencia artificial de esta aplicación. No soy una persona. Puedo ayudarte con entrenamiento, nutrición y hábitos, pero puedo cometer errores. Contrasta la información importante, especialmente la relacionada con tu salud.",
  },
} as const;
...
export const AI_TRANSPARENCY_POLICY = `${AI_TRANSPARENCY_POLICY_START}
...
export function composeAiSystemPrompt(basePrompt: string | null | undefined): string {
...
export function createAiDisclosureMessage(): {
  ...
  return {
    role: "assistant",
    content: AI_TRANSPARENCY_COPY.es.introMessage,
